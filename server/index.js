...
io.on('connection', function(socket){
  ...
  /*
   * Выбираем следующего стреляющего
   */
  ...
  /*
   * Вопрос открыт - запускаем таймер
   */
  ...
  /*
   * Инициализации игры первым игроком
   */
